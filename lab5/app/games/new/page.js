...
export default function NewGamePage() {
  ...
  // Stworzenie referencji do pola opisu (Zadanie na +0.5)
  ...
  const handleSubmit = async (e) => {
    ...
    // Wyciągamy wartość bezpośrednio z pola przez referencję
    ...
    try {
      await addDoc(collection(db, "games"), {
        ...
        description: [descriptionValue], // Przekazujemy wyciągniętą wartość z useRef
        isSold: false,
        createdAt: new Date(),
        ownerId: user.uid,   
  ...
  return (
    <div className="p-8 max-w-md mx-auto text-black">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        {/* Podpięcie pod pole kluczowej referencji `ref={descriptionRef}` i usunięcie onChange */}
        <textarea
          name="description"
          ref={descriptionRef}
          placeholder="Opis gry (obsługiwany przez useRef)..."
